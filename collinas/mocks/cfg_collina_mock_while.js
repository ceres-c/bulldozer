 ...
 * f = 0;
 * li = 0;
 * while(f < 5) // WAS: li = f < 5 ? 2048 : 5120 // 0
 *     g += f.toString(); // 2048
 *     f++;
 *     li = f < 7 ? 3072 : 8192;
 *     M = "here";
 *     li = 7168 // 3072
 *     li = M ? 6144 : 10240; // 7168
 *     M = "here2"
 *     li = 9216; // 6144
 *     M = "here3" // 9216
 *     li = 10240
 ...
 * g += ", finished" // 5120
 * li = M ? 1024 : 4096
 * g += " appended outside loop" // 1024
 * li = 4096
 * g += " alternative append" // 4096
 * 
 */
