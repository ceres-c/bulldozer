        ...
        if (Nt) {
          ...
          if (To) {
            ...
            if (r === 27) {
              ...
              if (Oe) { // If window.__acjs_awsc_140 has already been written in the DOM (which means collina has been initialized)
                ...
                ie = N;
                if (N) { // If bind exists for function e (bind supported by browser)
                  N = Se[vo]; // Se = window, vo = "navigator"
                  Q = N[Z](); // N = window.navigator, Z = "getBattery"
                  if (N[Z]()) { // If can get the battery
                    gr[50] = 2;
                ...
                Ro |= D;
                Ro |= Lo;
                if (Ao) { // If touch is enabled, check if platform is "coherent" (according to a static list of device they have chosen. X86 phones won't work)
                  M = Le;
                }
                Ro |= un;
                ie[23] = Ro;
                ...
                //w.push(62850517797, 66371638833, 3300911541, 25239194928, 4, 0); // ScriptEngineMajorVersion
                L = "currentScript";
                ...
                if (P[$]) { // $ = "hasOwnProperty" (window.hasOwnProperty is not supported on IE, check if using browsers other than IE)
                  ...
                  De = "HTMLDocument";
                  un = De;
                  if (G) { // G = "HTMLMediaElement" => Checking against a string, is this always executed?
                    De = P[ze];
                    D = "species";
                  ...
                  T = Go;
                  Go = P[ze];
                  if (P[ze]) { // Same as above, but saving window.Symbol.hasOwnProperty in its own variable Go
                    De = P[ze];
                    Go = De[$];
                  }
                  De = L;
                  ...
                  L = P[D];
                  mn |= Q;
                  if (P[D]) { // window["PerformanceTiming"]
                    ne = P[D];
                  ...
                  Q = N;
                  if (L) {
                    //w.push(233447861, 208148190464, 21826034401, 3, 1); // mozAutoplayEnabled
                ...
                if (yn.indexOf(T)) { // On Apple mobile device
                ...
                if (!z) { // z = window.__acjs or window._uab_module
                  if (window[Ct]) { // Ct = "UA_Opt"
                    ...
                    if (document[me]) { // me = "body"
                      ...
                      if (!document[zn]) { // Get head from current document
            ...
            re = r === 2;
            ke = r === 13;
            if (r === 2) { // Register callback to element
              z = p; // p = e function's 4th parameter
              T = void 0;
              Se = void 0;
              R = d; // d = e function's 3rd parameter
              Y = v; // v = e function's 5th parameter
              V = s; // s = e function's 2nd parameter
              if (V[q]) { // q = "attachEvent" (used only on IE < 9)
                m = R === B; // B = "focus"
                P = 0;
                if (R === B) {
                  Oe = "onfocusin";
                ...
                if (V[So]) { // V = window, So = "addEventListener" (for anything other than IE < 9)
                  ...
                  if (m) {
                    P = Y; // Y = e function's 5th parameter
                    ...
                    V[So](R, z, P); // window.addEventListener"eventname", listener, options)
                  }
                }
              }
            }
            ...
            be = r === 9;
            if (r === 9) { // getBattery success callback
            ...
            if (be) { // be = r === 28
              ...
              Re = new s(y); // s function's 2nd parameter
            ...
            be = r === 0;
            co = r === 16;
            if (r === 0) { // Checks if the function's 2nd parameter equals 6
              be = s === 6;
            }
            y = be;
            if (be) { // be = r === 0 && s === 6 - Return 0
              be = void 0;
              be = 0;
          ...
          if (+be === be) {
            ...
            if (pe) { // pe = be === 7
              ...
              Fe = de;
              if (de) { //  typeof window.console.log === "function"
                ...
                if (ve[Ne]) { // window.console.context
                  ...
                  qe = ho;
                  if (!ho) { // If couldn't get context().log => use window.console.log
                    qe = de;
                  }
                  de = qe;
                } else {
            ...
            if (Qo) { // Qo = be === 15 - Detect puppeteer/chromedriver remote browser control
              ...
              ge = pe.indexOf(Ee);
              Ee = ~ge;
              if (~ge) { // Anything other than -1 will execute since ~(-1)=0, but ~1=-2 which is true. JAVASCRIPT!
