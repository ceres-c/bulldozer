...
const inlinable = require('./inlinable');
const { functionContainsWeirdness } = require('./fn-contains-weirdness');
...
module.exports.negate = function (expr, isBooleanContext, requireResult = true) {
  return negate(expr, isBooleanContext, requireResult)
}

module.exports.fixStatementList = function (statements) {
  return fixStatementList(statements)
}